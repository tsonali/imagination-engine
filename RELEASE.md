...
- [x] **Imagination**: use-case gauntlet green (rehearsal fidelity, alert-calm, active-scene,
      grief register, embodiment, weird prompts). Adapter: n281 PROMOTED PERMANENT.
      ✅ CLOSED: Battery11 ALL 6 PASS for n281 confirmed beat28 (2026-07-14):
      intimacy ✅ (4 pronoun fixes by postprocessor, no corruption visible), eagle ✅✅,
      mid-switch ✅ REGISTER (alert-calm correct), grief-pet ✅ STRUCTURAL (human POV,
      tennis ball, bench), MRI ✅ (in-tube, drums transformation), repeat-variety ✅ 0% overlap.
      n302 REJECTED (eagle "You are an eagle, flying over the mountains" ×10 — severe repetition).
      n281 remains live (MD5: bce29e61472323003c948fbe07031115).
